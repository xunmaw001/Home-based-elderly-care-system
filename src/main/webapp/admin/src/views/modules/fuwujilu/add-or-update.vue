<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生活物品需求" prop="shenghuowupinxuqiu">
          <el-input v-model="ruleForm.shenghuowupinxuqiu" 
              placeholder="生活物品需求" clearable  :readonly="ro.shenghuowupinxuqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生活物品需求" prop="shenghuowupinxuqiu">
              <el-input v-model="ruleForm.shenghuowupinxuqiu" 
                placeholder="生活物品需求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品需求" prop="yaopinxuqiu">
          <el-input v-model="ruleForm.yaopinxuqiu" 
              placeholder="药品需求" clearable  :readonly="ro.yaopinxuqiu"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食品需求" prop="shipinxuqiu">
          <el-input v-model="ruleForm.shipinxuqiu" 
              placeholder="食品需求" clearable  :readonly="ro.shipinxuqiu"></el-input>
        </el-form-item>
        <div v-else>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuwumude = true;
          ...
          if(o=='shenghuowupinxuqiu'){
            this.ruleForm.shenghuowupinxuqiu = obj[o];
	    this.ro.shenghuowupinxuqiu = true;
            continue;
          }
          if(o=='yaopinxuqiu'){
      ...
      this.$http({
		...
		if(json.renyuanleixing!=''&&json.renyuanleixing){
              		this.ruleForm.renyuanleixing = json.renyuanleixing
		}
