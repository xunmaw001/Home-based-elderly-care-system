<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务目的" prop="fuwumude">
          <el-input v-model="ruleForm.fuwumude" 
              placeholder="服务目的" clearable  :readonly="ro.fuwumude"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务目的" prop="fuwumude">
              <el-input v-model="ruleForm.fuwumude" 
                placeholder="服务目的" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="生活用品需求" prop="shenghuoyongpinxuqiu">
          <el-select v-model="ruleForm.shenghuoyongpinxuqiu" placeholder="请选择生活用品需求">
            <el-option
                v-for="(item,index) in shenghuoyongpinxuqiuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="生活用品需求" prop="shenghuoyongpinxuqiu">
	      <el-input v-model="ruleForm.shenghuoyongpinxuqiu"
                placeholder="生活用品需求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="药品需求" prop="yaopinxuqiu">
          <el-select v-model="ruleForm.yaopinxuqiu" placeholder="请选择药品需求">
            <el-option
                v-for="(item,index) in yaopinxuqiuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="药品需求" prop="yaopinxuqiu">
	      <el-input v-model="ruleForm.yaopinxuqiu"
                placeholder="药品需求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="食品需求" prop="shipinxuqiu">
          <el-select v-model="ruleForm.shipinxuqiu" placeholder="请选择食品需求">
            <el-option
                v-for="(item,index) in shipinxuqiuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="食品需求" prop="shipinxuqiu">
	      <el-input v-model="ruleForm.shipinxuqiu"
                placeholder="食品需求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidizhi = true;
          ...
          if(o=='fuwumude'){
            this.ruleForm.fuwumude = obj[o];
	    this.ro.fuwumude = true;
            continue;
          }
          if(o=='shenghuoyongpinxuqiu'){
            this.ruleForm.shenghuoyongpinxuqiu = obj[o];
	    this.ro.shenghuoyongpinxuqiu = true;
            continue;
          }
          if(o=='yaopinxuqiu'){
            this.ruleForm.yaopinxuqiu = obj[o];
	    this.ro.yaopinxuqiu = true;
            continue;
          }
          if(o=='shipinxuqiu'){
            this.ruleForm.shipinxuqiu = obj[o];
	    this.ro.shipinxuqiu = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
		...
		if(json.laorenzhaopian!=''&&json.laorenzhaopian){
              		this.ruleForm.laorenzhaopian = json.laorenzhaopian
		}
		if(json.lianxidianhua!=''&&json.lianxidianhua){
              		this.ruleForm.lianxidianhua = json.lianxidianhua
		}
		if(json.lianxidizhi!=''&&json.lianxidizhi){
              		this.ruleForm.lianxidizhi = json.lianxidizhi
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/shenghuoyongpinxinxi/shenghuoyongpin`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.shenghuoyongpinxuqiuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              url: `option/yaopinxinxi/yaopin`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.yaopinxuqiuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              url: `option/shiwuxinxi/shiwu`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.shipinxuqiuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shenghuofuwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shenghuofuwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
