<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="老人当前状态" prop="laorendangqianzhuangtai">
          <el-select v-model="ruleForm.laorendangqianzhuangtai" placeholder="请选择老人当前状态">
            <el-option
                v-for="(item,index) in laorendangqianzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="紧急联系人姓名" prop="jinjilianxirenxingming">
          <el-input v-model="ruleForm.jinjilianxirenxingming" 
              placeholder="紧急联系人姓名" clearable  :readonly="ro.jinjilianxirenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="紧急联系人姓名" prop="jinjilianxirenxingming">
              <el-input v-model="ruleForm.jinjilianxirenxingming" 
                placeholder="紧急联系人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="紧急联系人号码" prop="jinjilianxirenhaoma">
          <el-input v-model="ruleForm.jinjilianxirenhaoma" 
              placeholder="紧急联系人号码" clearable  :readonly="ro.jinjilianxirenhaoma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="紧急联系人号码" prop="jinjilianxirenhaoma">
              <el-input v-model="ruleForm.jinjilianxirenhaoma" 
                placeholder="紧急联系人号码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="紧急联系人关系" prop="jinjilianxirenguanxi">
          <el-input v-model="ruleForm.jinjilianxirenguanxi" 
              placeholder="紧急联系人关系" clearable  :readonly="ro.jinjilianxirenguanxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="紧急联系人关系" prop="jinjilianxirenguanxi">
              <el-input v-model="ruleForm.jinjilianxirenguanxi" 
                placeholder="紧急联系人关系" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="居家养老服务范围" prop="jujiayanglaofuwufanwei">
          <el-input v-model="ruleForm.jujiayanglaofuwufanwei" 
              placeholder="居家养老服务范围" clearable  :readonly="ro.jujiayanglaofuwufanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="居家养老服务范围" prop="jujiayanglaofuwufanwei">
              <el-input v-model="ruleForm.jujiayanglaofuwufanwei" 
                placeholder="居家养老服务范围" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="档案更新日期" prop="dangangengxinriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.dangangengxinriqi" 
                type="date"
                placeholder="档案更新日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dangangengxinriqi" label="档案更新日期" prop="dangangengxinriqi">
              <el-input v-model="ruleForm.dangangengxinriqi" 
                placeholder="档案更新日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	jiwangbingshi : false,
	jinjilianxirenxingming : false,
	jinjilianxirenhaoma : false,
	jinjilianxirenguanxi : false,
	jujiayanglaofuwufanwei : false,
	dangangengxinriqi : false,
	userid : false,
      },
      ruleForm: {
        ...
        jujiayanglaofuwufanwei: '',
        dangangengxinriqi: '',
        userid: '',
      },
          laorenxingbieOptions: [],
          shentizhuangkuangOptions: [],
          laorendangqianzhuangtaiOptions: [],
      rules: {
          danganbianhao: [
  ...
  created() {
	this.ruleForm.dangangengxinriqi = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiwangbingshi = true;
          ...
          if(o=='jinjilianxirenxingming'){
            this.ruleForm.jinjilianxirenxingming = obj[o];
	    this.ro.jinjilianxirenxingming = true;
            continue;
          }
          if(o=='jinjilianxirenhaoma'){
            this.ruleForm.jinjilianxirenhaoma = obj[o];
	    this.ro.jinjilianxirenhaoma = true;
            continue;
          }
          if(o=='jinjilianxirenguanxi'){
            this.ruleForm.jinjilianxirenguanxi = obj[o];
	    this.ro.jinjilianxirenguanxi = true;
            continue;
          }
          if(o=='jujiayanglaofuwufanwei'){
            this.ruleForm.jujiayanglaofuwufanwei = obj[o];
	    this.ro.jujiayanglaofuwufanwei = true;
            continue;
          }
          if(o=='dangangengxinriqi'){
            this.ruleForm.dangangengxinriqi = obj[o];
	    this.ro.dangangengxinriqi = true;
            continue;
          }
          if(o=='userid'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shentizhuangkuangOptions = "良好,一般,较差".split(',')
            this.laorendangqianzhuangtaiOptions = "在家,住院".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
