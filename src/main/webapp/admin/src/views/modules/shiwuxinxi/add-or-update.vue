<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食物" prop="shiwu">
          <el-input v-model="ruleForm.shiwu" 
              placeholder="食物" clearable  :readonly="ro.shiwu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="食物" prop="shiwu">
              <el-input v-model="ruleForm.shiwu" 
                placeholder="食物" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
