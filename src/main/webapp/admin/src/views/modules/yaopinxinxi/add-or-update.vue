<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品" prop="yaopin">
          <el-input v-model="ruleForm.yaopin" 
              placeholder="药品" clearable  :readonly="ro.yaopin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品" prop="yaopin">
              <el-input v-model="ruleForm.yaopin" 
                placeholder="药品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
